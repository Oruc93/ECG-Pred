...
experiment = mlflow.set_experiment("Attention tests - Symbol - Icentia") # Conv-AE-LSTM-P good
...
train(NNsize=int(2**3), 
      total_epochs=400, 
      length_item= 32,# 2**6, # Minimum 4 seconds. Because calc_symbols needs at leat 2 beats. in seconds
